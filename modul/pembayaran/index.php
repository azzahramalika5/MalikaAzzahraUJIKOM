                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button
                                        ...
                                        data-bs-toggle="modal"
                                        data-bs-target="#edit<?= $p['id_pembayaran']; ?>"
                                    >
                                        Ubah
                                    </button>

                                    <a
                                        href="?hapus=<?= $p['id_pembayaran']; ?>"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    >
                                                        ...
                                                        <?= $p['status']=='sudah bayar' ? 'selected' : ''; ?>>
                                                            Sudah Bayar
                                                        </option>

                                                        <option value="belum bayar"
                                                        <?= $p['status']=='belum bayar' ? 'selected' : ''; ?>>
                                                            Belum Bayar
                                                        </option>
